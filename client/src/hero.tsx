...
const Hero = () => {
    ...
    return(
        <>
        <div className="w-screen h-[92%] n grid grid-cols-custom gap-x-[20px] justify-center grid-rows-12 relative">
            ...
            <p className="-rotate-90 col-start-11 leading-[55px] a text-[120px] row-start-10 text-vour "><p className="opacity-40">robert</p> <br /><p className="text-black opacity-70">Pattison</p></p>
        </div>
        </>
    )
}
